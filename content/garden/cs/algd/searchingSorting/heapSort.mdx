...
We have already seen the [selection sort](/garden/cs/algd/searchingSorting/selectionSort) algorithm. However, 
...
The heap sort algorithm is very simply we first construct a [heap](/garden/cs/algd/trees/heaps) from the 
