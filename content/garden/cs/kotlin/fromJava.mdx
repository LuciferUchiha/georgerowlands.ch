...
Kotlin was created by JetBrains in 2011 as an improved alternative to Java. Kotlin is more modern, concise, and safer
...
generates `.class` files just like the Java compiler that can then be executed on the Java Virtual Machine (JVM).
