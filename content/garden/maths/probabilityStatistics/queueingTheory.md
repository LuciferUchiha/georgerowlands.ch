...
{{< figure
  src="/images/maths/bediensystemeGraph.png"
  alt="bediensystemeGraph"
  caption="bediensystemeGraph"
>}}

Daraus erhalten wir dann die folgende Formeln für die Elemente der Grenzverteilung $\pi^*=(p_0,p_1)$

```mathp_0=\frac{(1-\lambda h)\cdot \mu}{(1-\lambda h)\cdot \mu + \lambda} \text{ mit } {h\to 0} = \frac{\mu}{\mu + \lambda}```

```mathp_1=1-p_0=\frac{\lambda}{\mu + \lambda}```
...
{{< figure
  src="/images/maths/bediensystemeFormeln.png"
  alt="bediensystemeFormeln"
  caption="bediensystemeFormeln"
>}}
...
```mathE(N_Q)=\sum_{j=s+1}^{s+c}{(j-s)p_j}```
...
```mathE(N_s)=\frac{\lambda}{\mu}\cdot (1-p_{s+c})```
...
{{< figure
  src="/images/maths/bediensystemeFormelnUnendlich.png"
  alt="bediensystemeFormelnUnendlich"
  caption="bediensystemeFormelnUnendlich"
>}}
