...
{{< figure
  src="/images/maths/absoluteValueNumberLine.png"
  alt="The absolute value can also be thought of as the distance from zero on the number line."
  caption="The absolute value can also be thought of as the distance from zero on the number line."
  width="700"
>}}
