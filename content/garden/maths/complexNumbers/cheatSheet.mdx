...
This has all the same information as [this section](/garden/maths/complexNumbers/complexNumbers) which contains all the definitions and explanations, but in a more concise format.
