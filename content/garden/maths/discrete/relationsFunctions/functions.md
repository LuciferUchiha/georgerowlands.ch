...
import {SideBySideBlock, Block} from "@/components/sideBySide"
...
Like with everything, visualizing functions can help us understand them better.
...
In linear algebra we discuss linear vs non-linear functions. There are then also equations there and linear equation systems.
{{< /callout >}}
...
{{< callout type="todo" >}}
We have domain, codomain, image and preimage what is all the difference?
{{< /callout >}}