...
{{< callout type="info" >}}
This was generated from a Jupyter notebook.
{{< /callout >}}
...
{{< figure
  src="/images/maths/broadcasting.png"
>}}
...
{{< figure
  src="/images/maths/broadcastingOuterProductVector.png"
  alt="The efficient calculation of the outer product of two vectors with broadcasting."
...
{{< figure
  src="/images/maths/broadcastingOuterProduct3Vectors.png"
  alt="Using three vectors to calculate a 3D tensor."
