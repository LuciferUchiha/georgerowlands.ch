...
Just like the normal inverse, the pseudoinverse has some useful properties that make it a powerful tool in linear algebra. For the general case we can show that the pseudoinverse satisfies the following property:
