...
However, if we try and do the same for the following two vectors we will find that we cannot create all vectors in 2D space because the system of equations will not have a solution:
