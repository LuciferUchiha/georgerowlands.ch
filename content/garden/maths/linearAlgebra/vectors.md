...
{{< figure
  src="/images/maths/vectorSubtractionGeometric.png"
  alt="The geometric interpretation of vector subtraction."
...
{{< figure
  src="/images/maths/vectorColumnPicture.png"
  alt="The column view of the two vectors in 2D space."
...
{{< figure
  src="/images/maths/vectorRowPicture.png"
  alt="The row view of the two vectors in the $\mu$-$\lambda$ plane."
...
{{< figure
  src="/images/maths/vectorCombinationTypes.png"
  alt="The yellow are represent the vectors that can be created by the combinations of the two vectors."
...
If the only solution to this equation is the trivial solution where all scalars are zero, then the set of vectors is linearly independent. From this it obviously follows that the **null vector even on it's own is always linearly dependent** as we can create it by multiplying any vector by zero.
...
{{< figure
  src="/images/maths/vectorEuclideanNorm.png"
  alt="We can see the 2D case of the Euclidean norm and the 3D case of the Euclidean norm."
...
{{< figure
  src="/images/maths/vectorNormalization.png"
  alt="We can see that the normalized vectors all have the same length, but different directions."
...
$$
\mathbf{x} \cdot \mathbf{y} = \cos(90) = 0
$$
...
\end{bmatrix} \cdot \begin{bmatrix}
    -2 \\
    1
\end{bmatrix} = 1 \cdot (-2) + 2 \cdot 1 = -2 + 2 = 0
$$
...
\end{bmatrix} \cdot \begin{bmatrix}
    -1 \\
    2
\end{bmatrix} = 4 \cdot (-1) + 2 \cdot 2 = -4 + 4 = 0
$$
{{< /callout >}}
