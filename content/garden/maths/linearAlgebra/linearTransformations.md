...
{{< figure
  src="/images/maths/linearTransformationAddition.png"
  alt="A visual representation of preserving addition in a linear transformation."
  caption="A visual representation of preserving addition in a linear transformation."
>}}

{{< figure
  src="/images/maths/linearTransformationScaling.png"
  alt="A visual representation of preserving scalar multiplication in a linear transformation."
...
{{< figure
  src="/images/maths/linearTransformationsMatrix1.png"
  alt="Mirroring and stretching a shape using a matrix as a linear transformation."
  caption="Mirroring and stretching a shape using a matrix as a linear transformation."
>}}

{{< figure
  src="/images/maths/linearTransformationsMatrix2.png"
  alt="Rotating and shearing a shape using a matrix as a linear transformation."
