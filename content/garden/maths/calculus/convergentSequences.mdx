...
<Callout type="proof">
We can also show this formally like in the solutions of the exercise
</Callout>
...
using binomialsatz like in exercise sheet 2. of some constant

Then also the square root of n

Then the square root of n - sqrt of n + 1.
</Callout>
...
<Callout type="todo">
From the exercises if an converges then so does a_n+1 + a_n and A-n? all of these different mixes.
</Callout>
