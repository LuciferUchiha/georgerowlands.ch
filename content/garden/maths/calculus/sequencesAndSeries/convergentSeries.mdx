...
So if we have such a series that fullfils the conditions above, we just need to show that the sequence of partial sums is bounded to show that the series converges. 
