...
```math\int{f(x)\,dx}=\int{f(g(x))\cdot g(x)'\,dx}```
...
```math\int_{0}^{1}{x\cdot \sqrt{1+x^2}}```
...
```math\int_{0}^{1}{x\cdot \sqrt{1+x^2}}=\int_{u=1}^{u=2}{x\cdot \sqrt{u}\,\frac{du}{2x}}=\int_{1}^{2}{\frac{1}{2}\cdot \sqrt{u}\,du}=\frac{1}{2}\int_{1}^{2}{(u)^{\frac{1}{2}}\,du}```

Weil $(\frac{2}{3}u^{\frac{3}{2}})'=(u)^{\frac{1}{2}}$ können wir schreiben

```math\frac{1}{2}\cdot\Big|\frac{2}{3}u^{\frac{3}{2}}\Big|_1^2=\frac{1}{3}\cdot\Big|\sqrt{u^3}\Big|_1^2=\frac{1}{3}(\sqrt{8}-1)```
