...
{{< figure
  src="/images/maths/convergenceEpsilonNeighborhood.svg"
  alt="Epsilon neighborhood around the limit a with radius epsilon and entry index"
...
{{< figure
  src="/images/maths/convergenceLimitUniqueness.png"
  alt="Epsilon neighborhood around two limits L and M"
...
{{< figure
  src="/images/maths/convergenceBoundedness.png"
  alt="Illustration of the idea that convergent sequences are bounded"
...
{{<callout type="todo">}}
Add the plot for the harmonic sequence here
{{</callout>}}
...
$$
\begin{align*}
\left| n^{\frac{1}{n}} - 1 \right| < \epsilon \\
-\epsilon < n^{\frac{1}{n}} - 1 < \epsilon \\
1 - \epsilon < n^{\frac{1}{n}} < 1 + \epsilon \\
...
$$
\begin{align*}
(1 + \epsilon)^{n} = 1 + n\epsilon + \frac{n(n-1)}{2}\epsilon^2 + \ldots + \epsilon^n \\
(1 + \epsilon)^{n} \geq 1 + \frac{n(n-1)}{2}\epsilon^2 + 0 \\
(1 + \epsilon)^{n} \geq \frac{n(n-1)}{2}\epsilon^2
\end{align*}
$$
...
$$
\begin{align*}
n < (1 + \epsilon)^{n} \geq \frac{n(n-1)}{2}\epsilon^2 \\
...
$$
\begin{align*}
\lim_{n \to \infty} \left(\sqrt{n^2 + 3n} - n\right)^2 = \lim_{n \to \infty} \frac{\sqrt{n^2 + 3n} - n}{1} \cdot \frac{\sqrt{n^2 + 3n} + n}{\sqrt{n^2 + 3n} + n} \\
...
= \lim_{n \to \infty} \frac{3n}{\sqrt{n^2(1 + \frac{3}{n})} + n} \\
= \lim_{n \to \infty} \frac{3n}{n \sqrt{1 + \frac{3}{n}} + n} \\
= \lim_{n \to \infty} \frac{3}{\sqrt{1 + \frac{3}{n}} + 1} \\
= \lim_{n \to \infty} \frac{3}{K + 1}
\end{align*}
$$
...
$$
\begin{align*}
\left|\sqrt{1 + \frac{3}{n}} - 1\right| = \left|\frac{\sqrt{1 + \frac{3}{n}} - 1}{1}\frac{\sqrt{1 + \frac{3}{n}} + 1}{\sqrt{1 + \frac{3}{n}} + 1}\right| \\
= \left|\frac{(1 + \frac{3}{n}) - 1}{\sqrt{1 + \frac{3}{n}} + 1}\right| \\
= \left|\frac{\frac{3}{n}}{\sqrt{1 + \frac{3}{n}} + 1}\right| \\
= \frac{3}{n(\sqrt{1 + \frac{3}{n}} + 1)}
\end{align*}
$$
...
\begin{align*}
\left|\sqrt{1 + \frac{3}{n}} - 1\right| < \epsilon \\
\frac{3}{n(\sqrt{1 + \frac{3}{n}} + 1)} < \epsilon \\
\frac{3}{2n} < \epsilon \\
3 < 2n\epsilon \\
\frac{3}{2\epsilon} < n
\end{align*}
...
$$
\begin{align*}
\sqrt{n} - \sqrt{n + 1} &= \frac{\sqrt{n} - \sqrt{n + 1}}{1} \cdot \frac{\sqrt{n} + \sqrt{n + 1}}{\sqrt{n} + \sqrt{n + 1}} \\
&= \frac{(\sqrt{n})^2 - (\sqrt{n + 1})^2}{\sqrt{n} + \sqrt{n + 1}} \\
&= \frac{n - (n + 1)}{\sqrt{n} + \sqrt{n + 1}} \\
&= \frac{-1}{\sqrt{n} + \sqrt{n + 1}} \leq \frac{-1}{\sqrt{n} + \sqrt{n}} = \frac{-1}{2\sqrt{n}}
\end{align*}
$$
...
$$
\begin{align*}
\left|(\sqrt{n} - \sqrt{n + 1}) - 0\right| < \epsilon \\
\left|\frac{-1}{\sqrt{n} + \sqrt{n + 1}}\right| < \epsilon \\
\left|\frac{-1}{2\sqrt{n}}\right| < \epsilon \\
\frac{1}{2\sqrt{n}} < \epsilon \\
\frac{1}{2\epsilon} < \sqrt{n} \\
\frac{1}{4\epsilon^2} < n
\end{align*}
$$
...
$$
\begin{align*}
|c_n - (a \pm b)| &= |(a_n \pm b_n) - (a \pm b)| \\
&= |(a_n - a) \pm (b_n - b)| \\
&\leq |(a_n - a) + (b_n - b)|=|a_n - a| + |b_n - b| < \frac{\epsilon}{2} + \frac{\epsilon}{2} = \epsilon \\
\end{align*}
$$ 
{{< /callout >}}
{{< callout type="example" >}}
...
|a_n \cdot b_n - a \cdot b| &< \epsilon \\
&\leq |a_n| \cdot |b_n - b| + |b| \cdot |a_n - a| \\
&\leq K \cdot |b_n - b| + |b| \cdot |a_n - a| \\
&\leq K \cdot \frac{\epsilon}{K + |b|} + |b| \cdot \frac{\epsilon}{K + |b|} \\
&= \frac{K \cdot \epsilon + |b| \cdot \epsilon}{K + |b|} \\
&= \frac{(K + |b|) \cdot \epsilon}{K + |b|} \\
&= \epsilon
\end{align*}
$$
{{< /callout >}}
...
$$
\begin{align*}
\frac{n^2 - 2n}{n^2 + n + 1} &= \frac{n^2(1 - \frac{2}{n})}{n^2(1 + \frac{1}{n} + \frac{1}{n^2})} \\
&= \frac{1 - \frac{2}{n}}{1 + \frac{1}{n} + \frac{1}{n^2}} \\
&= \frac{1 - 0}{1 + 0 + 0} \\
&= 1
\end{align*}
$$
...
$$
|a_n - a| < \frac{\epsilon |b|}{3}, \qquad |b_n - b| < \min\left(\frac{|b|}{2}, \frac{\epsilon |b|^2}{3 (|a|+1)}\right)
$$

Set $N = \max(N_1, N_2)$. Then for $n \geq N$, 

$$
\begin{align*} \left| \frac{a_n}{b_n} - \frac{a}{b} \right| &= \left| \frac{a_n b - a b_n}{b_n b} \right| \\
&= \left| \frac{a_n b - a b + a b - a b_n}{b_n b} \right| \\ 
&= \left| \frac{b(a_n - a) + a(b - b_n)}{b_n b} \right| \\ 
&\leq \frac{|b||a_n - a| + |a||b_n - b|}{|b_n||b|} 
\end{align*} 
$$
...
$$
\begin{align*}
\lim_{n \to \infty} \frac{3^n + (-2)^n}{3^n - 2^n} &= \lim_{n \to \infty} \frac{3^n(1 + (-\frac{2}{3})^n)}{3^n(1 - (\frac{2}{3})^n)} \\
&= \lim_{n \to \infty} \frac{\lim_{n \to \infty} 1 + \lim_{n \to \infty} (-\frac{2}{3})^n}{\lim_{n \to \infty} 1 - \lim_{n \to \infty} (\frac{2}{3})^n} \\
&= \frac{1 + 0}{1 - 0} \\
&= 1
\end{align*}
$$
...
{{< figure
  src="/images/maths/convergenceSqueezeTheorem.png"
  alt="Illustration of the idea behind the squeeze theorem"
...
{{< callout type="todo" >}}
Add the plot showing the squeeze theorem for this example
{{< /callout >}}
...
$$
\begin{align*}
\lim_{n \to \infty} \sqrt[n]{17^n} \leq \lim_{n \to \infty} \sqrt[n]{5^n + 11^n + 17^n} \leq \lim_{n \to \infty} \sqrt[n]{3 \cdot 17^n} \\
17 \leq \lim_{n \to \infty} \sqrt[n]{5^n + 11^n + 17^n} \leq 17 \\
\lim_{n \to \infty} \sqrt[n]{5^n + 11^n + 17^n} = 17
\end{align*}
$$
{{< /callout >}}
...
{{< figure
  src="/images/maths/convergenceMonotonicity.jpg"
  alt="Illustration of the idea behind the monotone convergence theorem"
...
{{< figure
  src="/images/maths/convergenceGeometricSequence.webp"
  alt="Illustration of the idea behind the geometric sequence"
...
{{< figure
  src="/images/maths/convergenceHeronsMethod.gif"
  alt="Animation showing Heron's method to approximate the square root of 5."
...
{{< figure
  src="/images/maths/convergenceLimesSuperiorInferior.png"
  alt="Limes Superior and Limes Inferior going towards the upper and lower bounds of the sequence."
...
1. We start with $I_1 = [m, M]$.
2. We then divide $I_1$ in half. At least one half contains infinitely many $a_n$; call it $I_2$.
3. Repeat this process: bisect $I_k$ and select the subinterval $I_{k+1}$ that contains infinitely many $a_n$.
...
$$
a_n = \begin{cases}
1 + \sqrt{\frac{k}{12k + 1}} & \text{if } n = 3k + 1 \text{ for } k \in \mathbb{N} \\
\frac{5k^3 + k}{k^3+1} & \text{if } n = 3k + 2 \text{ for } k \in \mathbb{N} \\
\frac{(-1)^k}{k} & \text{if } n = 3k + 3 \text{ for } k \in \mathbb{N}
\end{cases}
$$
...
$$
\begin{align*}
b_n &= 1 + \sqrt{\frac{k}{12k + 1}} \\
\lim_{k \to \infty} 1 + \sqrt{\frac{k}{12k + 1}} &= 1 + \sqrt{\frac{1}{12}} 
\end{align*}
$$
...
$$
\begin{align*}
c_n &= \frac{5k^3 + k}{k^3+1} \\
\lim_{k \to \infty} \frac{5k^3 + k}{k^3+1} &= \frac{5 + \frac{1}{k^2}}{1 + \frac{1}{k^3}} = 5
\end{align*}
$$
...
\begin{align*}
d_n &= \frac{(-1)^k}{k} \\
\lim_{k \to \infty} d_n &= \lim_{k \to \infty} \frac{(-1)^k}{k} = 0
\end{align*}
$$
...
$$
\begin{align*}
\lim_{n \to \infty} a_n &= \lim_{n \to \infty} \left(\frac{1}{n} + (-1)^n \cdot \frac{1}{n}\right) \\
\begin{cases}
\frac{2}{n} & \text{if $n$ is even} \\
0 & \text{if $n$ is odd}
\end{cases}
\end{align*}
$$
