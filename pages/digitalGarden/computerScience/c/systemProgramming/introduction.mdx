...
tags: [c, unix, system programming, operating systems, posix, system calls, kernel, kernel user mode]
---
...
![unixStructure](/compSci/unixStructure.png)
...
![systemCalls](/compSci/systemCalls.png)
