import Callout from "../../../../../components/Callout/Callout";Because I am a computer scientist I don't just care about using graphs but also about how to store them. There are
...
![adjacencyMatrixSimple](/compSci/adjacencyMatrixSimple.png)
