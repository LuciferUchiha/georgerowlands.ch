...
component includes a large portion of the graph, then it is commonly referred to as a **"giant component"**.
...
<Callout type="todo">
    Example of clustering coefficient calculation for clique and non-clique.
</Callout>
