...
<Callout type="todo">
    To do: An animation of the iterator moving through a linked list would be cool.
</Callout>
...
A possible implementation for an iterator over a [linked list](../algorithmsDataStructures/linkedLists) could look like this:
