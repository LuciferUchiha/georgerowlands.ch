...
dafür ist, dass die Wahrscheinlichkeit das eine Person genau 180cm gross ist, 0 ist. Grund dafür ist, dass die Person
180.000000000000001cm gross sein könnte, was nicht das gleiche ist wie 180cm. Deshalb macht es mehr Sin, dass $X$ einen
...
dies kann man dann später gut ausnutzen um Fragestellungen um zu formulieren.
...
Genau wie bei diskreten Zufallsvariablen kann man den Erwatungswer mit einer Formel berechnen.
...
$P(X \geq 150)= 1 - P(X <Callout 150) = 1 - normcdf(150,100,15) \approx 0.04$%

</Callout>

#### Standardisierung der Normalverteilung

Mit Standardisierung bezeichnen wir die transformation einer Normalverteilten Zufallsvariable $X$, zu einer
...
wenn ein neues Gerät $h$ Stunden läuft. Dies können wir mit ein wenig Mathe und bedingte Wahrscheinlichkeiten auch beweisen
