...
The inner product or also called the dot product is the most common type of vector multiplication. This is defined 
...
\end{bmatrix} \begin{bmatrix}
    ...
    \vdots \\
    y_n
\end{bmatrix} = x_1y_1 + x_2y_2 + \dots + x_ny_n = y_1x_1 + y_2x_2 + \dots + y_nx_n = \begin{bmatrix}
    y_1 & y_2 & \dots & y_n
\end{bmatrix} \begin{bmatrix}
    x_1 \\
    x_2 \\
