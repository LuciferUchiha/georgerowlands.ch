...
If we have a [set of real numbers](/digitalGarden/maths/discrete/setTheory#real-numbers), we can define a [subset](/digitalGarden/maths/discrete/setTheory#sub-and-superset) of this set by specifying a range of values. This subset is called an interval.
