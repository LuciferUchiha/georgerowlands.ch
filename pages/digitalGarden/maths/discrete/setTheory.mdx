...
The **cartesian product** of two sets $A$ and $B$, denoted by $A \times B$. The cartesian product is the set of all possible ordered pairs $(a,b)$ where $a$ is an element of $A$ and $b$ is an element of $B$.
