...
The binomial coefficient is a mathematical function that often appears in various areas of mathematics but especially 
...
Where $n$ and $k$ are non-negative integers and $n!$ is the [factorial](./factorial) of $n$.
