...
There are some common problems that you may encounter when using Git that my [basic guide](/digitalGarden/cs/git/basics) does not cover. Here are some solutions to those problems.
