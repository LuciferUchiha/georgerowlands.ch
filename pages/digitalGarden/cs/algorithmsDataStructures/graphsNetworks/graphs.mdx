...
which isn't exactly a good walk for our health. Notice also that on a walk or a closed walk we can visit the same vertex multiple 
times. So we can go from our house to the park and back to our house and then to the shop and back to our house. This changes 
...
## Handshaking Lemma and Density

$$
\sum_{v \in V} \text{deg}(v) = 2|E|
$$

this leads us to the definition of the density of a graph. 
