...
To solve this problem we can simply use the [Breadth First Search (BFS) algorithm](/digitalGarden/cs/algorithmsDataStructures/graphsNetworks/bfs).
...
We can also use the [Depth First Search (DFS) algorithm](/digitalGarden/cs/algorithmsDataStructures/graphsNetworks/dfs) to find the shortest path 
