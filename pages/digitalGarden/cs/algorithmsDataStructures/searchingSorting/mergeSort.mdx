...
[binary search](/digitalGarden/cs/algorithmsDataStructures/searchingSorting/searching#binary-search), 
...
Unlike with previous sorting algorithms such as [bubble sort](/digitalGarden/cs/algorithmsDataStructures/searchingSorting/bubbleSort) 
or [insertion sort](/digitalGarden/cs/algorithmsDataStructures/searchingSorting/insertionSort), the merge sort algorithm is not in-place. 
...
<Callout type="proof">
We design the decision tree just like with the [proof of the lower bound of structured search](/digitalGarden/cs/algorithmsDataStructures/searchingSorting/searching#lower-bound-of-structured-search).
