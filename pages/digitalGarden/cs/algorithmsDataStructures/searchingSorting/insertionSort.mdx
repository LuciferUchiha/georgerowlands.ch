...
maintain the following invariant from the [correctness proof of the bubble sort algorithm](/digitalGarden/cs/algorithmsDataStructures/searchingSorting/bubbleSort#correctness):
